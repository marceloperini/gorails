...
$(document).ready(function() {
    ...
    flyingcloud.addEventListener('onload',increaseLoaded);

    flyingcloud = engine.createBitmap({
        src: "/assets/go_gamification/flyingcloud-6da97b048832fb66d78a37c7d7f9ce7a6c52e2219330d8da5af6f27dcb147788.png",
        x: engine._stageWidth + 20,
        y: 80
    });
