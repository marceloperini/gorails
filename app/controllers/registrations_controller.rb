...
class RegistrationsController < Devise::RegistrationsController
  ...
  def sign_up_params
    params.require(:user).permit(:first_name, :last_name, :email, :password, :password_confirmation, :cpf, :provider, :uid, :terms_of_use)
  end
  ...
  def account_update_params
    params.require(:user).permit(:first_name, :last_name, :nickname,:cpf,:email, :password, :password_confirmation,
                                 ...
                                 :mother, :address, :neighborhood, :geography_state_id, :zip_code, :special_needs, :complement,:need_certificate,:digital_certificate,:printed_certificate,
