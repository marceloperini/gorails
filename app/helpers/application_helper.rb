module ApplicationHelper
  ...
  def date_range_picker_tag(campo_inicio, campo_final, label, valor_inicio = nil, valor_final = nil, required = false, bootstrapform = true, customize = nil)
    ...
    conteudo += "<div class='input-group input-small'>
       #{text_field_tag campo_inicio, valor_inicio, :class => 'form-control input-small date-picker', "data-mask" => "99/99/9999", "data-provide"=>"datepicker",:style => 'border-top-left-radius: 4px; border-bottom-left-radius: 4px;', :disable_plugin => true}
          <span class='input-group-addon date-range-picker'>até</span>
      #{text_field_tag campo_final, valor_final, :class => 'form-control input-small date-picker', "data-mask" => "99/99/9999", "data-provide"=>"datepicker", :style => 'border-top-right-radius: 4px; border-bottom-right-radius: 4px;', :disable_plugin => true}
      </div>
  </div>"
    conteudo.html_safe
